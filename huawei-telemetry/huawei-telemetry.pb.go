...
type TelemetrySelfDefinedEvent struct {
	...
	ThresholdRelation    TelemetrySelfDefinedEvent_ThresholdRelation `protobuf:"varint,7,opt,name=thresholdRelation,proto3,enum=huawei_telemetry.TelemetrySelfDefinedEvent_ThresholdRelation" json:"thresholdRelation,omitempty"`
...
type TelemetryThreshold struct {
	...
	ThresholdOpType      TelemetryThreshold_ThresholdOpType `protobuf:"varint,2,opt,name=thresholdOpType,proto3,enum=huawei_telemetry.TelemetryThreshold_ThresholdOpType" json:"thresholdOpType,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                           `json:"-"`
	XXX_unrecognized     []byte                             `json:"-"`
	XXX_sizecache        int32                              `json:"-"`
}
...
func init() {
	proto.RegisterEnum("huawei_telemetry.Telemetry_Encoding", Telemetry_Encoding_name, Telemetry_Encoding_value)
	proto.RegisterEnum("huawei_telemetry.TelemetrySelfDefinedEvent_ThresholdRelation", TelemetrySelfDefinedEvent_ThresholdRelation_name, TelemetrySelfDefinedEvent_ThresholdRelation_value)
	proto.RegisterEnum("huawei_telemetry.TelemetryThreshold_ThresholdOpType", TelemetryThreshold_ThresholdOpType_name, TelemetryThreshold_ThresholdOpType_value)
	proto.RegisterType((*Telemetry)(nil), "huawei_telemetry.Telemetry")
	proto.RegisterType((*TelemetryGPBTable)(nil), "huawei_telemetry.TelemetryGPBTable")
	proto.RegisterType((*TelemetryRowGPB)(nil), "huawei_telemetry.TelemetryRowGPB")
	proto.RegisterType((*TelemetrySelfDefinedEvent)(nil), "huawei_telemetry.TelemetrySelfDefinedEvent")
	proto.RegisterType((*TelemetrySelfDefineThresTable)(nil), "huawei_telemetry.TelemetrySelfDefineThresTable")
	proto.RegisterType((*TelemetryThreshold)(nil), "huawei_telemetry.TelemetryThreshold")
}
